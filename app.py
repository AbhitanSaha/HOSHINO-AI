...
def upload_image():
    ...
    if operation_selection == 'gray':
    	...
    	print("There is a severe lack of image in the nessacary area. Please work to fix this issue, thank you in advance.")
